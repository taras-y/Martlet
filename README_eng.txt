...
In all cases, this notice must remain intact and an URL git@github.com:taras-y/Martlet.git
( https://github.com/taras-y/Martlet.git )
must be directly mentioned as an original (primary) source of the "Martlet" carol lyrics.
